...
class prepare:
    ...
    def __init__(self):
        # 未經過處理的資料
        self.ob = trainingData()
        self.origin_data =  self.ob.preprocess()
        self.standard_data = self.ob.standardize()
        self.origin_data = {
    ...
    def getTestData(self,
        ...
        features_selected = [i+"_1" for i in features_selected]
    ...
    def getTrainingData(self,
        ...
        if common_features:     # 假設有加入交集特徵，就取得交集特徵的欄位
            common_features_with_suffix = self.__add_suffix_based_on_year(common_features, year)
            ...
            if data_type == "ele":
                features_selected = ['H_Reflex_L', 'SNCV_Sur_R', 'F_Tib_L', 'MNCV_Tib_L', 'SLO_Sur_L', 'SLO_Sur_R', 'SNAP_Sur_L', 'CMAP_Tib_L', 'F_Tib_R', 'SNAP_Sur_R', 'SNAP_Ula_R']
                # features_selected = self.__add_suffix_based_on_year(features_selected, year)
            elif data_type == "tor":
                features_selected = ['有主觀徵象', '多倫多_knee左', '多倫多_碰鈍右', '多倫多_knee右', '多倫多_ankle左', '多倫多_刺鈍左', '多倫多_JPS鈍左', '多倫多_ankle右', '多倫多_刺', '多倫多_麻', '多倫多_JPS鈍右', '多倫多_振鈍左']
                # features_selected = self.__add_suffix_based_on_year(features_selected, year)
            ...
            features = selected_data[["{}_{}".format(feature,year) for feature  in features_selected]]
    ...
    def __add_suffix_based_on_year(features, year):
        # 動態決定 '_1' 或 '_2' 的後綴
